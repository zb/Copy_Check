...
It pushes sentences over the limit (default of 22 seems to be near the search display's boundary) to the end of the stack, so while it may not be pretty the longer fragments should still be represented.
